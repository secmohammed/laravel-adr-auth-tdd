...
use App\App\Http\Middleware\ProfileJsonResponse;
use App\App\Http\Middleware\SetPaymentProvider;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\App\Http\Middleware\SetLocalization::class,
        \Barryvdh\Cors\HandleCors::class,
        SetPaymentProvider::class,
    ];
    /**
    ...
    protected $middlewareGroups = [
        ...
        'api' => [
            ...
            \App\App\Http\Middleware\ParseJWTToken::class,
